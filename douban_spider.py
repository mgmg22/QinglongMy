...
def filter_content(item: dict) -> bool:
    ...
    myStations = [
        ...
        # "汉中路", "新闸路", "人民广场", "黄陂南路",
        # "陕西南路", "常熟路", "衡山路", "徐家汇", "宜山路", "漕溪路", "上海南站", "锦江乐园",
        "莲花路", "外环路", "莘庄",
        # 2号线
        ...
        # 13号线
        "13号线", "金运路", "金沙江西路", "丰庄", "祁连山南路", "真北路", "大渡河路", "金沙江路",
        "隆德路", "武宁路", "长寿路",
        # "江宁路", "汉中路", "自然博物馆", "南京西路", "淮海中路",
        ...
        "惠南", "惠南东", "书院", "临港大道", "滴水湖",
        # 17号线
        "17号线", "虹桥火车站", "诸光路", "蟠龙路", "徐盈路", "徐泾北城", "嘉松中路", "赵巷", "汇金路",
