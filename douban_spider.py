...
# # 排除项
user_black_list = [
    "沪上蜗居小豆豆", "🍃 🇨🇳", "大鱼海棠", "瓜瓜一号的墨迹", "娜娜小夭",
    "自由奔放", "江湖不良人", "华夏东路", "清风秀雅", "灵感之刃", "给你俩窝窝", "简单点", "忧伤的旋律", "C",
    "九头奈子", "阿绫子", "兔九九", "忘记了不该忘的", "李好闲。", "小张要增肌", "虚伪的世界",
    "森女与鹿林", "提子", "悲伤的诗篇", "相思成殇", "安静的等待", "-Joker", "今安", "未了",
    "旧梦乱心", "失宠的猫", "氧气柠檬红茶", "鲨鱼辣椒", "顾客至上", "繁花散尽", "祈鹤", "可怜式.暧情",
    "如花美眷", "徐广帅", "阿豆", "从悲伤中抽离", "今天吃什么呢？", "一切都挺好", "Choo", "sweet",
    "乐儿", "Foo", "克克", "稚气", "妮妮", "我装作鱼", "想当英雄小波比", "欣欣", "Sandra", "明明就", "荒野蛮神",
    "筑堰公寓zzlp", "一吃就胖小湛蓝", "月亮是我踹弯的", "上海链家小孙", "加班到很晚", "野的像风", "不将就i",
    "我恨我痴心", "南港┈清风", "北有孤酒", "不羁", "隔壁王学长", "我陪着你走",
    "淡蓝淡紫", "撒花冬瓜", "霏琅咫天涯", "Emily", "O D",
    "突然十年便过去c", "沪静", "失魂", "不为笨蛋⁶眼泪", "点到为止", "小弦切切如", "潇洒的无所谓", "运筹在我心",
    "Jill.L🐳✨", "Jojojoding", "Aristocracy", "沈南锡", "老徐", "牛奶冰淇淋",
    ...
    "Alicia Xu", "蛊惑人心", "晓钟", "糟糕情书", "Vampire", "爱意", "雾里有江馆", "梦里。开花",
    "阿哦", "世界和平", "能吃6碗饭", "沐九", "S H U S H", "曾经的那个人", "换2/14", "R'",
    "😯👀", "陌生人小姐", "青年社区", "沐九", "阿磊", "我也不知道", "一壶清酒", "橘徕服兮",
    "青春有我", "厌世症", "浪迹天涯", "JJJJJJJ", "烟雨江畔", "你看我作甚", "酒酿", "你在偷看我吗",
    "小", "未莱", "浅忆", "Sophia", "烟雨江畔", "你看我作甚", "酒酿", "你在偷看我吗",
]
...
def filter_content(item: dict) -> bool:
    ...
    blackList = [
        ...
        "5000", "4900", "4800", "4700", "4600", "4500", "4400", "4300", "4200", "4100", "4050",
        ...
        "普陀", "松江",
        "奉贤", "海湾",
        "上钢二村", "江桥二村", "茅台花苑", "会展中心", "荷三小区",
        "汤臣豪园", "爱博", "外滩BFC", "沪闵路", "荷三小区",
    ]
    ...
    myStations = [
        # 1号线
        "富锦路", "友谊西路", "宝安公路", "共富", "呼兰路", "通河新村", "共康路", "彭浦新村", "汶水路",
        "上海马戏城", "延长路", "中山北路",
        # "上海火车站","汉中路", "新闸路", "人民广场", "黄陂南路", "陕西南路", "常熟路", "衡山路", "徐家汇", "宜山路", "漕溪路", "上海南站", "锦江乐园",
        "莲花路", "外环路", "莘庄",
        # 2号线
        ...
        # 4号线（环线）
        # "宜山路", "虹桥路","延安西路","中山公园", "金沙江路", "曹杨路", "镇坪路", "中潭路", "上海火车站", "宝山路", "海伦路", "临平路", "大连路", "杨树浦路", "浦东大道", "世纪大道",
        "浦电路", "蓝村路", "塘桥", "南浦大桥",
        # "西藏南路", "鲁班路", "大木桥路", "东安路","上海体育场", "上海体育馆","宜山路",
        # 5号线
        "莘庄", "春申路", "银都路", "颛桥", "北桥", "剑川路", "东川路", "金平路", "华宁路", "文井路", "闵行开发区",
        # 6号线
        "6号线", "港城路", "外高桥保税区北", "航津路", "外高桥保税区南", "洲海路", "五洲大道", "东靖路",
        # "巨峰路","五莲路",
        ...
        # 8号线
        "八号线", "8号线", "市光路", "嫩江路", "翔殷路", "黄兴公园", "延吉中路", "黄兴路",
        # "江浦路", "鞍山新村", "四平路", "曲阳路", "虹口足球场", "西藏北路", "中兴路", "曲阜路", "人民广场","大世界","老西门", "陆家浜路", "西藏南路",
        ...
        # "海伦路","四川北路", "天潼路", "南京东路", "豫园", "老西门", "新天地", "陕西南路", "上海图书馆", "交通大学",
        "虹桥路", "宋园路", "伊犁路", "水城路", "龙溪路", "动物园", "虹桥1号航站楼",
        "虹桥2号航站楼", "虹桥火车站", "航中路", "龙柏新村", "紫藤路", "七莘路",
        # 11号线
        "11号线", "迪士尼", "康新公路", "秀沿路", "罗山路", "御桥", "严御路", "浦三路", "三林东", "三林",
        "东方体育中心", "龙耀路", "云锦路",
        # "龙华", "上海游泳馆", "徐家汇", "交通大学", "江苏路","隆德路", "曹杨路",
        "枫桥路", "真如", "上海西站", "李子园", "祁连山路", "武威路", "桃浦新村", "南翔", "马陆",
        "嘉定新城", "白银路", "嘉定西", "嘉定北", "上海赛车场", "昌吉东路", "上海汽车城", "安亭", "兆丰路", "光明路",
        "花桥",
        # 12号线
        "七莘路", "虹莘路", "顾戴路", "东兰路", "虹梅路",
        # "虹漕路", "桂林公园", "漕宝路","龙漕路", "龙华", "龙华中路", "大木桥路", "嘉善路", "陕西南路", "南京西路", "汉中路", "曲阜路", "天潼路","国际客运中心", "提篮桥", "大连路", "江浦公园", "宁国路","隆昌路", "爱国路", "复兴岛", "东陆路", "巨峰路",
        "杨高北路", "金京路", "申江路", "金海路",
        # 13号线
        "13号线", "金运路", "金沙江西路", "丰庄", "祁连山南路", "真北路", "大渡河路",
        # "金沙江路", "隆德路","武宁路","长寿路","江宁路", "汉中路", "自然博物馆", "南京西路", "淮海中路", "新天地", "马当路",
        "世博会博物馆", "世博大道", "长清路", "成山路", "东明路", "华鹏路", "下南路", "北蔡", "陈春路", "莲溪路",
        "华夏中路", "中科路", "学林路", "张江路",
        # 14号线
        "14号线", "封浜", "金园五路", "临洮路", "嘉怡路", "定边路", "真新新村", "真光路", "铜川路", "真如", "中宁路",
        # "曹杨路", "武宁路", "武定路", "静安寺", "黄陂南路", "大世界",
        "豫园", "陆家嘴", "浦东南路", "浦东大道",
        "昌邑路", "歇浦路", "龙居路", "云山路", "蓝天路", "黄杨路", "云顺路", "浦东足球场", "金粤路", "桂桥路",
        # 15号线
        ...
        "漕盈路", "淀山湖大道", "朱家角", "东方绿舟",
        # 18号线
        "18号线", "长江南路", "殷高路", "上海财经大学", "复旦大学", "国权路", "抚顺路",
        # "江浦路","江浦公园", "平凉路",
        "丹阳路", "昌邑路", "民生路", "杨高中路", "迎春路", "龙阳路",
