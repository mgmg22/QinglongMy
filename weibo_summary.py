...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "梅西",
        "运动 户外 篮 球 国足 曼联 湖人 男单 女单 决赛 女双 马拉松 兴奋 跳 八段",
        # 导演
        "徐峥 于正",
        # 脱口秀
        "付鹏 徐志胜 庞博 付航",
        ...
        # 英文
        "chill like vivo oppo iqoo vlog cp mbti boy 强森 布朗尼 萨 姆 哈登 cos gq love vip star new baby ins ost cue",
    ]
    gameBlackList = [
        # 游戏
    ...
    countryList = [
        ...
        #
        "古 保护 村 乡镇 文化 同意 丝路 官宣 间谍 国防 大使 议员 整治 声明 提高 时代 时光",
    ]
    lifeList = [
        # 人
        ...
        "电话 沙发 伞 呐 杯",
        # 学
        "教授 校 清华 浙大 专家 班主任 小学 中学 初中 高中 高一 高二 高三 大学 大一 大二 大三 大四 同学 级 师 押 硕 打卡 早八 迟到 简历 摸鱼 应届 成年 私立 考研 面试 训 肖四 研究生 专业",
        # 健康
        ...
        # 衣
        "穿 裤 衣 戒指 镯 搭 妆 面霜 挑染 裙 猴 羽绒 洞洞鞋 ootd",
        # 食
    ...
    otherList = [
        ...
        # 情绪
        "担心 抑郁 情绪 骗 背锅 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕 笑 气 差 怒",
        # 表述
        "最 才 还 仍 只 观 佩服",
        # 问
