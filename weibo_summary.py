...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "马天宇 王大陆 秦昊 伊能静 邓伦 王子文 周也 成毅 任嘉伦",
    ...
    countryList = [
        ...
        # 动物
        "动物 熊 柯基 蛇 鸡 虎 狗 猫 蜂 鼠 鹤 鸟屎 野猪 蝎 鲨鱼 海龟 蟑螂 鹿",
    ]
    otherList = [
        # 单字
        "座 骑 厕 车 说 谈 称 聊 宿 寿 爵 神 枪",
        # 娱乐
        ...
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警 城管",
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话 沙发",
        # 食物
        ...
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅",
        # 水
