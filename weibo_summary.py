...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        # 轻
        "造谣 网传 吐槽 贫困 古人 幻 加油 保护 魂 烂尾 尸 疑 去世 澡 贷 截图 洗白 不雅 偷 怼 酒后 公交 诈 怒喷 彩蛋 未来 人均",
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 精神 拖延 炎症 症状 嘌呤 针灸 心脏 肺 肾 ptsd 驼背 聋哑 受伤 虱 感冒 咳嗽 睡眠 住院 异物",
        # 动物
    ...
    otherList = [
        ...
        "正直 勇敢",
        # 人称
        "你 丈夫 奶 婴 爷 姐 父 儿 弟 妈 爹 老公 妻 嫂 夫妇 女孩 前夫 友 男子 老人 女子 女生 小伙 宝 年轻 老头 小孩",
        # 身份
        "主人 租客 女主播 实习 司机 情侣 全职 村委 保安 开除 丁克 教练 快递 员工 导游 博主",
        # 食物
        "面包 烤肉 茶 蛋糕 粥 夜宵",
        # 学
        "校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 大一 大二 大三 大四 打卡 早八 迟到 简历",
        # 水
        "这 差点 没认出 再也不 告诉 偶遇 童年 证据 盘点 评论区 了解 心愿 真正",
        "嘴真严 世上 歉 副业 仪式 江湖 人类 生日 逻辑 状态 早年 付出",
        # 情绪
        "担心 抑郁 情绪 骗 竟 背锅 值得 恶心 智障 离谱 太香了 杀疯了 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗",
        # 问
