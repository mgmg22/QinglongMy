...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        "热 冷 季 秋 暖 酸 甜 苦 辣 臭",
        # 新闻
        "兼职 爆料 奔现 优惠 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 四六级 安检 不雅 老外 纪委 落 回应 慈善 吵架 首都 怼 酒后 偷",
        # 健康
    ...
    otherList = [
        ...
        # 女性
        "妆 面霜 名媛 闺蜜 公主 强奸 猥亵 侵犯 出轨 性侵 美甲 回购 护肤 奶茶 断糖 镯 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 穿搭 爽",
        # 人称
