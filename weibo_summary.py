...
def filter_tr(tr):
    ...
    nameBlackList = [
        # 演员
        "刘德华 章子怡 成龙 李连杰 周星驰 郭富城 黄晓明 杨幂 赵丽颖 迪丽热巴 王一博 肖战 易烊千玺 王俊凯 王源 鹿晗 吴亦凡 张艺兴 黄子韬 杨洋 张婧仪 严屹宽",
    ...
    gameBlackList = [
        "恋与制作人 光遇 王者荣耀 炉石传说 如鸢 秋季赛 第五人格 光与夜之恋 原神 星穹铁道 kpl 皮肤 婚 孕 抽卡",
        "沈星回",
        # 其他
        "男子 女子 小伙 女孩 女儿 专家 朋友圈 主人 夫妇 vlog 女团 对战 爷 00后 名媛 柯基  闺蜜 男友 租客 弟弟 姐 妈 生图 代言 儿子 父亲 钓系 公主 演员 维密 首秀 班主任",
        "清华 童年 女主播 歌手 车主 师 实习 司机",
        "恋综 宝 吻戏 路透 票房 预告 时尚 强奸 美甲 回购 护肤 跳楼 骨折 癌 奔现 优惠 赛 收官 预制菜 兼职 公司 妆 解约 解散 经纪 网红 娱",
        "到底有多 为什么总是 竟然是 飒 belike 值得 到底是 海洋 vivo",
    ]
