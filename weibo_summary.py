...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "佘 方 许 尚 程 毛 庾 戚 阮 荀 冉 闵 朴 翁 易",
        # 名
        "磊 祺 咪 梓 禹 楷 灿 栩 琦 毓 鑫 莹 豪 琳 帝 俊 楠 婧 娜 皓 霏 霞 惠 莎 丽 蕾 梦 昊 翔 尔 晓",
        # 英文
    ...
    countryList = [
        "东北 海洋 敦煌 灵隐 辽",
        "新疆 青海",
        "法国 巴黎 土耳其 印度 中东 瑞士 印尼 埃及 缅 澳 福岛",
        "台积电 机器",
        # 天气
        "热 冷 季 秋 暖 酸 甜 苦 辣 臭 香 冬 夏 春 雪 寒 太阳 星期 今天 冰 降温 天空 爽",
        # 新闻
        "爆料 自曝 奔现 薅 有人 平均 年度 爆款 回应 首都 主持 成人礼 歼 央视",
        # 轻
        "加油 去世 怼 公交 彩蛋 索赔",
        # 负面
        ...
        #
        "古 保护 县 村 乡镇 文化 同意 丝路 官宣 间谍 国防 大使 议员 整治 声明 提高 时代 时光 国旗",
    ]
    lifeList = [
        # 人
        ...
        # 健康
        "骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 住院 异物 艾滋 hiv 内分泌 烧 甲醛",
        # 身体
        "身 耳 眼 鼻 屁股 腿 脸 痘 发色 心脏 肺 肾 子宫 牙 背 体质 聋哑 尸 帅 好看 胖 瘦 肚子 手",
        # 衣
        "穿 裤 衣 戒指 镯 搭 妆 面霜 挑染 裙 羽绒 洞洞鞋 ootd",
        # 食
        "外卖 食物 面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒 蒜 笋 粮 梨",
        # 动物
    ...
    otherList = [
        ...
        "说 对话 谈 称 聊 告诉 喊 言",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 婚 孕 胎 飒 经纪 网红 公司 解约 解散 维密 路透 票房 收官 钓系 镜头 亮相 海报 刊 出道 拍 秀 名人",
        "开机 追星 长得 辟谣 古装 魅 梗 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 女主 见面 配角 素人 大片 磕 结局 白月光 番 盛典 广告 主题",
        # 女性
        "名媛 闺蜜 公主 美甲 回购 护肤 断糖 滤镜 媚 吻 依偎 妃 爱 哄 浪漫 国货 中式 月子 造型 温柔 美容 美颜 领证 图",
        # 动词
        "把 让 为 推 吹 走",
        # 未发生
        "呼吁 建议 警惕 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 理解 幻 仙 魂 如果 险 抽 预 命运",
        # 水
        "这 没认出 再也不 偶遇 童年 证据 盘点 评论区 了解 真正 技巧 辨别 正常 理由 名场面 评测 每天",
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 反应 格局 发现 奇葩 态度 原因 多数 现代 心路 回忆 区别 含金量 知道",
        # 情绪
        "担心 抑郁 情绪 骗 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕 笑 气 差 怒 破防",
        # 表述
        "最 才 还 仍 只 观 佩服 终于",
        # 问
