...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "佘 方 许 尚 程 毛 庾 戚 阮 荀 冉 闵 朴 翁 易 卞",
        # 名
    ...
    countryList = [
        ...
        "加油 去世 怼 公交 彩蛋 索赔",
        # 负面
        "造谣 吐槽 贫困 烂尾 洗白 不雅 偷 人均 诈 逮捕 人贩 双开 烈士 安检 纪委 落 套路 贷 酒后 赌",
    ...
    lifeList = [
        # 人
        "你 丈夫 奶 婴 爷 姐 妹 父 儿 弟 哥 妈 爹 老公 爸 妻 嫂 夫妇 女孩 前夫 友 男子 老人 女子 女生 小伙 宝 年轻 老头 小孩 阿姨 老外 家人 市民 辈",
        # 身份
    ...
    otherList = [
        ...
        # 水
        "这 没认出 再也不 偶遇 证据 盘点 评论区 了解 真正 技巧 辨别 正常 理由 名场面 评测 每天",
