...
def filter_tr(tr):
    ...
    nameBlackList = [
        ...
        "杜海涛 谢娜 何炅 汪涵 撒贝宁",
        # 运动员
        "孙杨 丁宁 谌龙 宁泽涛 张继科 马龙 郭晶晶 全红婵 易建联 孙颖莎 王楚钦 帕尔默 樊振东 男单 决赛 郑钦文 曼联 热刺 王皓 林孝埈 林诗栋 王曼昱 王艺迪 国足 奥运 冠军",
        "比0 比1 比2 比3 比4 比5 比6 比7 比8 乒",
        "梅西",
        # 导演
        "张艺谋 冯小刚 徐峥 于正",
        # 脱口秀
        "脱口秀 李诞 付鹏 徐志胜 赵晓卉 庞博",
        # 其他
        ...
        "何猷君 徐锦江 金秀贤 曹宝儿 骆鑫 张棨乔 范晓萱 刘雯 听泉 时代少年团 gigi hanni 韩素希 李惠利",
    ]
    gameBlackList = [
        ...
        "恋综 鉴宝 吻戏 路透 票房 预告 时尚 强奸 美甲 回购 护肤 跳楼 骨折 癌 奔现 优惠 赛 收官 预制菜 兼职 公司",
        "到底有多 为什么总是 竟然是 飒",
    ]
