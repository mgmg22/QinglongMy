...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "梅西",
        "运动 户外 球 国足 曼联 湖人 男单 女单 决赛 女双 马拉松 兴奋 跳",
        # 导演
        "徐峥 于正",
        # 脱口秀
        "付鹏 徐志胜 庞博 付航",
        ...
        "何猷君 徐锦江 范晓萱 听泉 gigi hanni 周震南 费曼 董宇辉 景甜 权志龙 晓华 向太 王祖贤 王鹤棣 钟楚曦 包贝尔",
        "钟睒睒 沙一汀 梅艳芳 周芯竹",
        # 二
        "柯南 唐三",
        # 姓
        ...
        # 名
        "磊 祺 咪 梓 禹 楷 灿 栩 琦 毓 鑫 莹 豪 琳 帝 俊 楠 婧 娜 皓 霏 霞 惠 莎 丽 蕾 梦 昊 翔",
        # 英文
    ...
    gameBlackList = [
        ...
        "0后 0万",
        # 衣
        "穿 裤 内衣 戒指 镯 搭 妆 面霜 挑染 裙 猴 羽绒 洞洞鞋",
    ]
    countryList = [
        "北方 南方 东北 海洋 敦煌 新疆 灵隐",
        "中方 法国 巴黎 土耳其 印度 中东 瑞士 印尼 埃及 缅 澳 马尔代夫 福岛",
        # 天气
        ...
        "强奸 猥亵 侵犯 出轨 家暴 性侵 原谅 骚扰 杀 虐 死因 刀 拐",
        "正直 勇敢 慈善 锦旗 捐款",
        #
        "古人 幻 魂 保护 乡镇 文化 同意 丝路 官宣 间谍",
        # 健康
    ...
    otherList = [
        # 单字
        "座 骑 厕 车 宿 寿 爵 神 枪 瞬 个",
        # 说
        "说 对话 谈 称 聊 告诉",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 婚 孕 胎 飒 经纪 网红 公司 解约 解散 维密 生图 代言 路透 票房 预告 时尚 收官 钓系 镜头 亮相 海报 出道 拍 分手 秀 名人",
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 女主 见面 配角 素人 大片 磕 人气 明星 结局 白月光 番",
        # 女性
        ...
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警 城管 物业",
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话 沙发 会员 地铁 澡 浴",
        # 食物
        "面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒",
        # 动词
        "把 让 为",
        # 学
        "大学 教授 校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 高一 高二 高三 大一 大二 大三 大四 硕 打卡 早八 迟到 简历 摸鱼 应届 成年 私立 考研 面试 训 肖四",
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 明白 理解",
        # 水
        "这 没认出 再也不 偶遇 童年 证据 盘点 评论区 了解 真正 技巧 辨别 正常 理由 名场面 评测",
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 原因 多数 现代 心路 回忆",
        # 情绪
        "担心 抑郁 情绪 骗 背锅 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕 笑",
        # 问
