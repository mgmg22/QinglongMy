...
def filter_tr(tr):
    ...
    nameBlackList = [
        ...
        # 姓
        "杨 汪 陈 朴 翁 黄 刘 杜 花 林 沈 韩",
        # 单字
        "娱 艺 婚 孕 飒 爷 尸 师 友 赛 癌 妆 热 冷 座 贷 校 疑 歌 舞 骑 厕 臭 车 剧",
    ...
    gameBlackList = [
        "恋与制作人 光遇 王者 炉石 如鸢 秋季赛 第五人格 光与夜之恋 原神 星穹铁道 kpl jdg 皮肤 抽卡 阵容 回归 uzi 勇士 联盟 战队",
        # 其他
        "男子 老人 女子 小伙 女孩 女儿 专家 主人 夫妇 女团 对战 名媛 柯基 闺蜜 租客 弟弟 姐 妈 生图 代言 儿子 父亲 钓系 公主 演员 维密 首秀 班主任 情侣 老公",
        "清华 童年 女主播 实习 司机 小学",
        "恋综 宝 吻戏 路透 票房 预告 时尚 强奸 猥亵 侵犯 出轨 套路 美甲 回购 护肤 跳楼 骨折 奔现 优惠 收官 预制菜 兼职 公司 解约 解散 经纪 网红 救人 爆料",
