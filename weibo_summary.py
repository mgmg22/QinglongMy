...
def filter_item(realtime_item):
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 感谢 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 大秀 素人 大片 磕 人气",
        # 女性
        ...
        # 食物
        "面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面",
        # 学
        "大学 校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 大一 大二 大三 大四 打卡 早八 迟到 简历",
        # 水
        "这 差点 没认出 再也不 告诉 偶遇 童年 证据 盘点 评论区 了解 心愿 真正 神器 社交 技巧 辨别 建议",
        "嘴真严 世上 歉 副业 仪式 江湖 人类 生日 逻辑 状态 早年 付出",
        # 情绪
        "担心 抑郁 情绪 骗 竟 背锅 值得 恶心 智障 离谱 太香了 杀疯了 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又",
        # 问
