...
def filter_item(realtime_item):
    ...
    gameBlackList = [
        ...
        "电竞 上路 下路 中路 对战 一血 mvp 传奇 战神 国服 退役 ig",
    ...
    countryList = [
        ...
        # 新闻
        "兼职 爆料 奔现 优惠 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 四六级 安检 不雅 老外 纪委 落 回应 慈善 吵架 首都 怼 酒后 偷 公交 去世 薅 造谣",
        # 健康
    ...
    otherList = [
        ...
        # 女性
        "妆 面霜 名媛 闺蜜 公主 美甲 回购 护肤 断糖 镯 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 搭 爽 哄 浪漫 眼 国货",
        "强奸 猥亵 侵犯 出轨 家暴 性侵 原谅",
        # 人称
        "奶 婴 爷 姐 父 儿 弟 妈 爹 老公 妻 嫂 夫妇 女孩 前夫 师 友 男子 老人 女子 女生 小伙 宝 年轻 老头",
        # 身份
        ...
        "担心 嘴真严 世上 迟到 后悔 歉 吐槽 简历 副业 古人 幻 内耗 加油 狠狠 狂喜 意难平 保护",
    ]
