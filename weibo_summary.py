...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 精神 拖延 炎症",
        # 动物
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 道歉 女装 模仿 影 松弛 耶 顶流 表情 粉丝 感谢 档 照",
        # 女性
        "妆 面霜 名媛 闺蜜 公主 强奸 猥亵 侵犯 出轨 性侵 美甲 回购 护肤 奶茶 断糖 镯 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃",
        # 人称
