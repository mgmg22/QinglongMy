...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "磊 祺 咪",
        # 单字
        "娱 艺 婚 孕 飒 爷 尸 师 友 赛 癌 妆 热 冷 座 贷 校 疑 歌 舞 骑 厕 臭 车 剧 婴 说 鼠 吻 恋 乐 季 秋 毯 逝 幼 痘 演",
        # 家庭
    ...
    gameBlackList = [
        ...
        "宝 吻戏 路透 票房 预告 时尚 强奸 猥亵 侵犯 出轨 性侵 套路 美甲 回购 护肤 跳楼 骨折 奔现 优惠 收官 预制菜 兼职 公司 解约 解散 经纪 网红 救人 爆料",
        "到底有多 为什么总是 竟然是 值得 到底是 海洋 谁能 北方 是懂 抑郁 情绪 骗 证据 飞机 差点 没认出 太香了 杀疯了 再也不 告诉 偶遇 怎么 良品铺子 开机 追星",
    ]
    countryList = [
        "法国 土耳其 印度 中东 瑞士",
    ]
