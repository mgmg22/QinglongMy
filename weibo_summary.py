...
def filter_tr(tr):
    ...
    nameBlackList = [
        ...
        "谢娜 何炅 撒贝宁",
        # 运动员
        "丁宁 谌龙 宁泽涛 张继科 马龙 郭晶晶 全红婵 易建联 孙颖莎 王楚钦 帕尔默 樊振东 男单 决赛 郑钦文 曼联 王皓 林孝埈 林诗栋 王曼昱 国足 奥运 冠军 郭艾伦 潘展乐",
        "梅西",
        # 导演
        "冯小刚 徐峥 于正",
        # 脱口秀
        ...
        "0后",
        # 英文
        "chill belike vivo oppo vlog cp mbti 强森",
    ]
    gameBlackList = [
        "恋与制作人 光遇 王者 炉石 如鸢 秋季赛 第五人格 光与夜之恋 原神 星穹铁道 kpl 皮肤 抽卡 阵容 回归 uzi 勇士",
        "沈星回",
        # 其他
        "男子 老人 女子 小伙 女孩 女儿 专家 主人 夫妇 女团 对战 名媛 柯基 闺蜜 租客 弟弟 姐 妈 生图 代言 儿子 父亲 钓系 公主 演员 维密 首秀 班主任 情侣 老公",
        "清华 童年 女主播 歌手 车主 实习 司机 小学",
        "恋综 宝 吻戏 路透 票房 预告 时尚 强奸 猥亵 出轨 美甲 回购 护肤 跳楼 骨折 奔现 优惠 收官 预制菜 兼职 公司 解约 解散 经纪 网红",
        "到底有多 为什么总是 竟然是 值得 到底是 海洋 谁能 北方 是懂 抑郁 情绪 骗 0万 嫌疑 证据 飞机",
    ]
    countryList = [
        "法国 土耳其 印度",
    ]
