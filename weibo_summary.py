...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        # 天气
        "热 冷 季 秋 暖 酸 甜 苦 辣 臭 冬 夏 春 雪 寒",
        # 新闻
        "兼职 爆料 奔现 优惠 薅 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 安检 老外 纪委 落 回应 慈善 吵架 首都 逮捕 主持",
        # 轻
        "造谣 后悔 网传 吐槽 贫困 古人 幻 内耗 加油 狂喜 意难平 保护 魂 烂尾 尸 疑 悼 去世 澡 贷 截图 洗白 不雅 偷 怼 酒后 公交 电诈",
        # 健康
    ...
    otherList = [
        ...
        # 女性
        "名媛 闺蜜 公主 美甲 回购 护肤 断糖 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 爽 哄 浪漫 眼 国货 中式 月子",
