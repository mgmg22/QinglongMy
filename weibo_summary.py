...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        "正直 勇敢 慈善 锦旗 捐款 浪费",
        #
        "古人 保护 乡镇 文化 同意 丝路 官宣 间谍 国防 大使 议员 整治 声明",
    ]
    lifeList = [
        # 人
        ...
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 会员 地铁 澡 浴 公摊",
        # 物
        "电话 沙发 伞 呐",
        # 学
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 女主 见面 配角 素人 大片 磕 人气 结局 白月光 番 盛典",
        # 女性
        "名媛 闺蜜 公主 美甲 回购 护肤 断糖 滤镜 媚 吻 依偎 妃 爱 哄 浪漫 国货 中式 月子 造型 温柔 美容 美颜 领证",
        # 动词
        "把 让 为 推 吹",
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 理解 幻 仙 魂 如果",
        # 水
