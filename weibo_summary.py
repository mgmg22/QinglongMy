...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        # 动物
        "动物 熊 柯基 蛇 鸡 虎 狗 猫 蜂 鼠 鹤 鸟屎 野猪 蝎 鲨鱼",
    ]
    otherList = [
        # 单字
        "座 骑 厕 车 说 宿",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 痘 婚 孕 飒 经纪 网红 公司 解约 解散 维密 首秀 生图 代言 路透 票房 预告 时尚 收官 钓系 镜头 亮相 海报 出道 拍",
        ...
        "嘴真严 世上 歉 副业 仪式 江湖 人类 生日 逻辑 状态 早年 付出 反应 格局 发现",
        # 情绪
