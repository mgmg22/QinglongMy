...
def filter_tr(tr):
    ...
    nameBlackList = [
        ...
        "何猷君 徐锦江 金秀贤 曹宝儿 骆鑫 张棨乔 范晓萱 听泉 时代少年团 gigi hanni 李惠利 鞠婧祎 周震南 赵一博 费曼 易梦玲 孟佳 董宇辉",
        # 姓
        "杨 汪 陈 朴 翁 黄 刘 杜 花 林 沈 韩 磊",
        # 单字
        "娱 艺 婚 孕 飒 爷 尸 师 友 赛 癌 妆 热 冷 座 贷 校 疑 歌 舞 骑 厕 臭 车 剧 婴 说 鼠 吻 恋 乐 季 秋",
    ...
    gameBlackList = [
        ...
        "到底有多 为什么总是 竟然是 值得 到底是 海洋 谁能 北方 是懂 抑郁 情绪 骗 证据 飞机 差点 没认出 太香了 杀疯了 再也不 告诉 偶遇",
    ]
    countryList = [
        "法国 土耳其 印度 中东",
    ]
