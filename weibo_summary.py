...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "何猷君 徐锦江 金秀贤 范晓萱 听泉 时代少年团 gigi hanni 李惠利 周震南 赵一博 费曼 易梦玲 孟佳 董宇辉 景甜 权志龙 晓华 向太 王祖贤 王鹤棣 钟楚曦 徐静蕾 汪苏泷",
        "钟睒睒 唐三 大冰 辛芷蕾 沙一汀",
        # 姓
    ...
    otherList = [
        ...
        # 情绪
        "担心 抑郁 情绪 骗 竟 背锅 值得 恶心 智障 离谱 太香了 杀疯了 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了",
        # 问
