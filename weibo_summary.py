...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 道歉 女装 模仿 影 松弛 耶",
        # 女性
        "妆 面霜 名媛 闺蜜 公主 强奸 猥亵 侵犯 出轨 性侵 美甲 回购 护肤 奶茶 断糖 镯 发色 滤镜 身材",
        # 天气
        "热 冷 季 秋 暖 酸 甜 苦 辣",
        # 人称
        ...
        "担心 嘴真严 世上",
        # 新闻
        "兼职 爆料 奔现 优惠 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 四六级 安检 不雅 老外 纪委 落网 回应 慈善 吵架",
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 血压 献血 一生 屁股 腿 脸 卫生 精神",
        # 动物
        "熊猫 柯基 蛇 鸡 虎",
    ]
    gameBlackList = [
