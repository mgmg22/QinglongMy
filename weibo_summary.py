...
def filter_item(realtime_item):
    ...
    lifeList = [
        ...
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警 城管 物业 消防 公安",
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话 沙发 会员 地铁 澡 浴 伞",
        # 健康
    ...
    otherList = [
        ...
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明白 理解 幻 仙 魂",
        # 水
