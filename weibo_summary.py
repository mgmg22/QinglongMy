...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "孙楠 那英 毛阿敏 韦唯 谭晶 腾格尔 阎维文 刀郎 降央卓玛 宋祖英 李谷一 董文华 王二妮 唐嫣 赵薇 窦骁 张钧甯 邱泽 金晨 尤长靖",
    ...
    countryList = [
        ...
        "热 冷 季 秋 暖 酸 甜 苦 辣 臭",
        # 新闻
        "兼职 爆料 奔现 优惠 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 四六级 安检 不雅 老外 纪委 落 回应 慈善 吵架 首都 怼 酒后 偷 公交",
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 精神 拖延 炎症 症状 嘌呤 针灸 心脏",
        # 动物
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉丝 感谢 档 照 合约 续约 资源 摄",
        # 女性
        "妆 面霜 名媛 闺蜜 公主 强奸 猥亵 侵犯 出轨 性侵 美甲 回购 护肤 奶茶 断糖 镯 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 搭 爽",
        # 人称
        ...
        "担心 嘴真严 世上 迟到 后悔 歉 吐槽 简历 副业 古人 幻 内耗",
    ]
