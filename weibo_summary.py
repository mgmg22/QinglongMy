...
def filter_item(realtime_item):
    ...
    otherList = [
        ...
        "座 骑 厕 车 说 宿",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 痘 婚 孕 飒 经纪 网红 公司 解约 解散 维密 首秀 生图 代言 路透 票房 预告 时尚 收官 钓系 镜头 亮相 海报 出道 拍 分手",
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 感谢 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 大秀 素人 大片 磕 人气 明星 杀青 结局",
        # 女性
