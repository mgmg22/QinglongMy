...
def filter_tr(tr):
    ...
    nameBlackList = [
        ...
        "杜海涛 谢娜 何炅 汪涵 撒贝宁",
        # 运动员
        "孙杨 丁宁 谌龙 傅园慧 宁泽涛 张继科 马龙 郭晶晶 全红婵 易建联 孙颖莎 王楚钦 帕尔默 樊振东 男单 决赛 郑钦文 曼联 热刺 王皓 林孝埈",
        # 导演
        "张艺谋 冯小刚 徐峥",
        # 脱口秀
        "李诞 付鹏 徐志胜",
        ...
        "尹净汉 王鹤润 秦岚 钟丽缇 杨丞琳 范玮琪 徐若瑄 戴佩妮 关淑怡 赵今麦 张真源 戚薇 张元英 东北雨姐 林允儿 佟丽娅 刘宇宁 刘浩存",
    ]
    gameBlackList = [
        "恋与制作人 光遇 王者荣耀 炉石传说 如鸢 秋季赛 第五人格",
        # 其他
        "男子 女子 朋友圈 主人 vlog 女团",
    ]
