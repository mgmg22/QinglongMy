...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "何猷君 徐锦江 听泉 gigi hanni 费曼 董宇辉 景甜 权志龙 王祖贤 王鹤棣 钟楚曦 钟睒睒 沙一汀 梅艳芳",
        # 二
        "柯南",
        # 姓
    ...
    otherList = [
        ...
        "说 对话 谈 称 聊 告诉 喊 言",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 婚 孕 胎 飒 经纪 网红 公司 解约 解散 维密 生图 路透 票房 收官 钓系 镜头 亮相 海报 刊 出道 拍 分手 秀 名人",
        ...
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 反应 格局 发现 奇葩 态度 原因 多数 现代 心路 回忆 区别 含金量",
        # 情绪
