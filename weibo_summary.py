...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        # 歌手
        "华晨宇 蔡徐坤 薛之谦 王力宏 田馥甄 萧敬腾 五月天 莫文蔚 苏打绿 陶喆 潘玮柏 蔡健雅 梁静茹 何洁 王铮亮 霉霉",
        # 主持人
        "何炅 撒贝宁",
        # 运动员
    ...
    countryList = [
        ...
        "加油 去世 怼 公交 彩蛋 索赔",
        # 负面
        "造谣 吐槽 贫 烂尾 洗白 不雅 偷 人均 诈 逮捕 人贩 双开 烈士 安检 纪委 落 套路 贷 酒后 赌 贪",
    ...
    lifeList = [
        ...
        # 健康
        "感染 三甲 骨折 奔现 白血病 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 住院 异物 艾滋 hiv 内分泌 烧 甲醛",
        # 身体
