...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "佘 方 许 尚 程 毛 庾 戚 阮 荀 冉 闵 朴 翁 易 卞 解 庄",
        # 名
        "磊 祺 咪 梓 禹 楷 灿 栩 琦 毓 鑫 莹 豪 琳 帝 俊 楠 婧 娜 皓 霏 霞 惠 莎 丽 蕾 梦 昊 翔 尔 晓 嬛 玟 菲 芳",
        # 英文
    ...
    otherList = [
        ...
        "把 让 为 推 吹 走",
        # 未发生
        "呼吁 建议 永远 差点 心愿 未 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 幻 仙 魔 魂 如果 险 抽 预 命运 提名",
        # 水
