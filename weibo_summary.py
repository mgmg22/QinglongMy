...
def filter_item(realtime_item):
    ...
    gameBlackList = [
        # 游戏
        "和平精英 光遇 王者 荣耀 炉石 如鸢 秋季赛 第五人格 星穹铁道 kpl jdg 皮肤 抽卡 阵容 回归 uzi 勇士 联盟 战队 九尾 绝区零 鸣潮 mlxg 剑网 方舟",
    ...
    countryList = [
        ...
        # 新闻
        "兼职 爆料 自曝 奔现 薅 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 安检 老外 纪委 落 回应 慈善 吵架 首都 逮捕 主持 成人礼 人贩 双开 烈士 歼 锦旗 屠杀 转账 晒",
        # 轻
        "造谣 网传 吐槽 贫困 古人 幻 加油 保护 魂 烂尾 尸 疑 去世 澡 贷 截图 洗白 不雅 偷 怼 酒后 公交 诈 怒喷 彩蛋 未来 人均 可能 以为 没想到",
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 睡眠 住院 异物 艾滋",
        # 身体
        "身 耳 屁股 腿 脸 心脏 肺 肾 子宫 牙 体质 驼背 聋哑",
        # 动物
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 感谢 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 素人 大片 磕 人气 明星 杀青 结局",
        # 女性
        ...
        # 水
        "这 差点 没认出 再也不 告诉 偶遇 童年 证据 盘点 评论区 了解 心愿 真正 社交 技巧 辨别 建议 警惕 正常 理由",
        "嘴真严 世上 歉 副业 仪式 江湖 人类 生日 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 背后 永远 相信",
        # 情绪
        "担心 抑郁 情绪 骗 竟 背锅 值得 恶心 智障 离谱 太香了 杀疯了 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又 哭 居然 焦虑",
        # 问
