...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 心脏 肺 肾 ptsd 驼背 聋哑 受伤 虱 感冒 咳嗽 睡眠 住院 异物 子宫 艾滋 牙 体质",
        # 动物
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 感谢 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 素人 大片 磕 人气 明星 杀青 结局 身",
        # 女性
        "名媛 闺蜜 公主 美甲 回购 护肤 断糖 发色 滤镜 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 爽 哄 浪漫 眼 国货 中式 月子 造型 好看 温柔 美容 美颜 领证",
