...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "何炅 撒贝宁",
        # 运动员
        "丁宁 谌龙 宁泽涛 马龙 全红婵 易建联 王楚钦 帕尔默 樊振东 郑钦文 王曼昱 奥运 冠军 丁俊晖 苏炳添 邓亚萍",
        "梅西",
        ...
        "柯南 唐三",
        # 姓
        "杨 汪 陈 朴 翁 黄 刘 杜 花 林 沈 韩 阮 曾 彭 虞 殷 崔 姚 罗 祝 冉 闵 张 孟 孙 孔 宋 赵 李 魏 谭 曹 郭 冯 霍 朱 蒋 谢 展",
        # 名
    ...
    otherList = [
        ...
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 明白 理解 幻 仙 魂",
        # 水
