...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        "正直 勇敢 慈善 锦旗 捐款 浪费",
        #
        "古人 保护 乡镇 文化 同意 丝路 官宣 间谍 国防 大使 议员 整治",
    ]
    lifeList = [
        # 人
        "你 丈夫 奶 婴 爷 姐 父 儿 弟 妈 爹 老公 爸 妻 嫂 夫妇 女孩 前夫 友 男子 老人 女子 女生 小伙 宝 年轻 老头 小孩 阿姨 老外 家人 市民",
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警 城管 物业 消防 公安 书记",
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话 沙发 会员 地铁 澡 浴 伞",
        # 学
        "大学 教授 校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 高一 高二 高三 大一 大二 大三 大四 硕 打卡 早八 迟到 简历 摸鱼 应届 成年 私立 考研 面试 训 肖四 求职 研究生",
        # 健康
        ...
        # 食
        "面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒 蒜 笋",
        # 动物
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 女主 见面 配角 素人 大片 磕 人气 明星 结局 白月光 番 盛典",
        # 女性
        "名媛 闺蜜 公主 美甲 回购 护肤 断糖 滤镜 媚 吻 依偎 妃 爱 哄 浪漫 国货 中式 月子 造型 温柔 美容 美颜 领证",
        # 动词
        "把 让 为 推",
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明白 理解 幻 仙 魂 如果",
        # 水
        "这 没认出 再也不 偶遇 童年 证据 盘点 评论区 了解 真正 技巧 辨别 正常 理由 名场面 评测 每天",
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 原因 多数 现代 心路 回忆 区别",
        # 情绪
        "担心 抑郁 情绪 骗 背锅 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕 笑",
        # 表述
        "最 才 还",
        # 问
