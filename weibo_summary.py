...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "关智斌 吴尊  贾静雯 周杰 苏有朋 吴奇隆 言承旭 周渝民 朱孝天 彭于晏 张国立 邓婕 张嘉译 海清 孙红雷",
        ...
        "开机 追星 长得 辟谣 撞脸 古装 魅 梗",
        # 女性
        "妆 面霜 名媛 闺蜜 公主 强奸 猥亵 侵犯 出轨 性侵 美甲 回购 护肤 奶茶 断糖 镯",
        # 天气
        "热 冷 季 秋 暖",
        # 人称
        ...
        # 新闻
        "预制菜 兼职 救人 爆料 跳楼 骨折 奔现 优惠 羊毛 套路 柯基 有人 白血病 平均 糖尿 疱疹 年度 捐款 爆款 带娃 四六级 安检",
    ]
    gameBlackList = [
        # 游戏
