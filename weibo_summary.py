...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        "强奸 猥亵 侵犯 出轨 家暴 性侵 原谅 骚扰 杀 虐 死因",
        "正直 勇敢 慈善 锦旗 捐款",
        #
    ...
    otherList = [
        ...
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话 沙发 会员 地铁",
        # 食物
        ...
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 原因",
        # 情绪
