...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "付鹏 徐志胜 庞博 付航",
        # 其他
        "郎朗 檀健次 王宝强 梁朝伟 吴谨言 高圆圆 周润发 梁家辉 古天乐 王昶 黎明 余文乐 郑伊健 代高政 古巨基",
        ...
        "钟睒睒 唐三 沙一汀 梅艳芳 周芯竹",
        # 姓
        "杨 汪 陈 朴 翁 黄 刘 杜 花 林 沈 韩 阮 曾 彭 虞 殷 崔 姚 罗 祝 冉 闵 张 孟 孙 孔 宋 赵 李 魏 谭 曹 郭 冯 霍 朱 蒋 谢",
        # 名
    ...
    gameBlackList = [
        ...
        "0后 0万",
        # 衣
        "裤 内衣 戒指 镯 搭 妆 面霜 挑染 裙 猴 羽绒 洞洞鞋",
    ]
    countryList = [
        "北方 南方 东北 海洋 敦煌 新疆",
        ...
        "正直 勇敢 慈善 锦旗 捐款",
        #
        "古人 幻 魂 保护 乡镇 文化 同意 丝路 官宣",
        # 健康
        "外卖 预制菜 救人 跳楼 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 睡眠 住院 异物 艾滋 hiv 内分泌",
        # 身体
    ...
    otherList = [
        ...
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 婚 孕 飒 经纪 网红 公司 解约 解散 维密 生图 代言 路透 票房 预告 时尚 收官 钓系 镜头 亮相 海报 出道 拍 分手 秀 名人",
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 素人 大片 磕 人气 明星 杀青 结局 白月光",
        # 女性
        ...
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警",
        # 生活
        "生活 工资 兼职 全职 副业 生日 社交 吵架 骂 转账 晒 相亲 带娃 开除 丁克 电话",
        # 食物
        "面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒",
        # 动词
        "把 让 为",
        # 学
        "大学 教授 校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 高一 高二 高三 大一 大二 大三 大四 硕 打卡 早八 迟到 简历 摸鱼 应届 成年 私立",
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为",
        # 水
        "这 没认出 再也不 告诉 偶遇 童年 证据 盘点 评论区 了解 真正 技巧 辨别 正常 理由 名场面 评测",
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 理解",
        # 情绪
        "担心 抑郁 情绪 骗 竟 背锅 值得 恶心 智障 离谱 杀疯了 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕",
        # 问
