...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "撒贝宁",
        # 运动员
        "丁宁 谌龙 宁泽涛 全红婵 王楚钦 王曼昱 奥运 冠军 丁俊晖 苏炳添",
        "梅西",
    ...
    countryList = [
        ...
        # 新闻
        "爆料 自曝 奔现 薅 有人 平均 年度 款 回应 首都 主持 成人礼 歼 央视 外交 地震 溺",
        # 轻
        "加油 去世 怼 公交 彩蛋 索赔",
        # 负面
    ...
    lifeList = [
        ...
        # 健康
        "中医 感染 三甲 骨折 奔现 白血病 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 住院 异物 艾滋 hiv 内分泌 烧 甲醛",
        # 身体
    ...
    otherList = [
        ...
        "把 让 为 推 吹 走",
        # 未发生
        "呼吁 建议 永远 差点 心愿 未 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 幻 仙 魔 魂 如果 险 抽 预 命运 提名 福",
        # 水
        "这 没认出 再也不 偶遇 证据 盘点 评论区 真正 技巧 辨别 正常 理由 名场面 评测 每天 节奏 规律 复盘",
