...
def filter_item(realtime_item):
    ...
    gameBlackList = [
        ...
        "电竞 选手 上路 下路 中路 对战 一血 mvp 传奇 国服 退役 ig 复出 金克丝 双城 英雄 签 转会 加盟 队 卫冕 战士",
    ...
    lifeList = [
        ...
        # 健康
        "外卖 救人 骨折 奔现 白血病 糖尿 疱疹 癌 血压 献血 一生 卫生 拖延 炎症 症状 嘌呤 针灸 ptsd 受伤 虱 感冒 咳嗽 住院 异物 艾滋 hiv 内分泌",
        # 身体
    ...
    otherList = [
        ...
        "把 让 为 推 吹 走",
        # 未发生
        "呼吁 建议 警惕 背后 永远 差点 心愿 未来 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 理解 幻 仙 魂 如果 险 抽 预",
        # 水
