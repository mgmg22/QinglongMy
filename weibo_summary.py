...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "何猷君 徐锦江 金秀贤 范晓萱 听泉 gigi hanni 李惠利 周震南 赵一博 费曼 易梦玲 孟佳 董宇辉 景甜 权志龙 晓华 向太 王祖贤 王鹤棣 钟楚曦 徐静蕾",
    ...
    otherList = [
        ...
        "座 骑 厕 车 说 宿",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 痘 婚 孕 飒 经纪 网红 公司 解约 解散 维密 首秀 生图 代言 路透 票房 预告 时尚 收官 钓系 镜头 亮相 海报",
