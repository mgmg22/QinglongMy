...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        # 名
        "磊 祺 咪 梓 禹 楷 灿 栩 琦 毓 鑫 莹 豪 琳 帝 俊 楠 婧",
        # 英文
    ...
    gameBlackList = [
        ...
        "电竞 上路 下路 中路 对战 一血 mvp 传奇 战神 国服 退役 ig 复出",
    ...
    countryList = [
        ...
        # 新闻
        "兼职 爆料 奔现 优惠 羊毛 套路 有人 平均 年度 捐款 爆款 带娃 四六级 安检 不雅 老外 纪委 落 回应 慈善 吵架 首都 怼 酒后 偷 公交 去世 薅 造谣 逮捕",
        # 健康
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉丝 感谢 档 照 合约 续约 资源 摄 组合 咖",
        # 女性
        "妆 面霜 名媛 闺蜜 公主 美甲 回购 护肤 断糖 镯 发色 滤镜 身材 相亲 屁股 腿 脸 媚 吻 依偎 鼻 妃 爱 搭 爽 哄 浪漫 眼 国货 中式 月子",
        "强奸 猥亵 侵犯 出轨 家暴 性侵 原谅",
        # 人称
        "奶 婴 爷 姐 父 儿 弟 妈 爹 老公 妻 嫂 夫妇 女孩 前夫 师 友 男子 老人 女子 女生 小伙 宝 年轻 老头 小孩",
        # 身份
        "校 专家 主人 租客 女主播 实习 司机 班主任 情侣 小学 中学 全职 村委 保安 开除 丁克 同学 教练 快递 员工 导游",
        # 水
        "背锅 什么 值得 到底 差点 没认出 太香了 杀疯了 再也不 告诉 偶遇 怎么 童年 清华 谁能 是懂 抑郁 情绪 骗 证据 盘点 评论区 原来 了解 心愿 吗 真正 恶心 智障 离谱",
        "担心 嘴真严 世上 迟到 后悔 歉 吐槽 简历 副业 古人 幻 内耗 加油 狠狠 狂喜 意难平 保护 灵魂 啥 竟然 仪式 江湖",
    ]
