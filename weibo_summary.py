...
def filter_item(realtime_item):
    ...
    lifeList = [
        ...
        # 身份
        "主人 租客 女主播 实习 司机 情侣 村委 保安 教练 员工 导游 博主 当事人 辅警 城管 物业 消防 公安 书记 议员",
        # 生活
        ...
        # 食
        "面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒 蒜",
        # 动物
    ...
    otherList = [
        ...
        "嘴真严 世上 歉 仪式 江湖 人类 逻辑 状态 早年 付出 反应 格局 发现 奇葩 态度 原因 多数 现代 心路 回忆 区别",
        # 情绪
        "担心 抑郁 情绪 骗 背锅 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕 笑 最",
        # 问
