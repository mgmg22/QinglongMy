...
def filter_item(realtime_item):
    ...
    countryList = [
        ...
        "台积电 机器 甲骨文",
        # 天气
        "热 冷 季 秋 暖 酸 甜 苦 辣 臭 香 冬 夏 春 雨 雪 寒 星期 今天 冰 降温 天空 爽",
        # 新闻
        "爆料 自曝 奔现 薅 有人 平均 年度 款 回应 首都 主持 成人礼 歼 央视 外交 地震 溺 直播",
        # 轻
        "加油 去世 怼 公交 彩蛋 索赔",
        # 负面
        "造谣 吐槽 贫 烂尾 洗白 不雅 偷 人均 诈 逮捕 人贩 双开 烈士 安检 纪委 落 套路 贷 酒后 赌 贪 市长",
        "强奸 猥亵 侵犯 出轨 性侵 原谅 骚扰 屠 杀 虐 死因 刀 拐 回扣",
    ...
    otherList = [
        ...
        # 水
        "这 没认出 再也不 偶遇 证据 盘点 评论区 真正 技巧 辨别 正常 理由 名场面 评测 每天 节奏 规律 复盘 燃",
