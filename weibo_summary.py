...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        "章子怡 成龙 肖战 严屹宽 成毅",
        # 歌手
        "华晨宇 田馥甄 萧敬腾 五月天 莫文蔚 苏打绿 陶喆 蔡健雅 霉霉",
        # 主持人
        "撒贝宁",
        # 运动员
        ...
        "那英 韦唯 阎维文 刀郎 降央卓玛 董文华 金晨 尤长靖 倪妮 井柏然 董洁 靳东 乐华 嘉行 沙溢 金星",
        "成毅 任嘉伦",
        "羽泉 任贤齐 田曦薇 章泽天 白敬亭",
        "听泉 gigi hanni 费曼 董宇辉 景甜 权志龙 钟楚曦 钟睒睒 沙一汀 单依纯",
        # 二
        "柯南",
        # 姓
        "杨 汪 陈 黄 刘 杜 花 林 韩 虞 殷 崔 姚 罗 祝 张 孟 孙 孔 宋 赵 李 魏 谭 曹 郭 冯 霍 朱 蒋 谢 叶 周 邓 吴",
        "贺 柳 申 付 庞 秦 向 范 伊 唐 贾 展 沈 关 郑 曾 彭",
        "佘 方 许 尚 程 毛 庾 戚 阮 荀 冉 闵 朴 翁 易 卞 解 庄 黎 祁 傅 何 戴 徐 樊 窦 梁 尹 王 胡 薛 邱 欧阳 潘 袁",
        # 名
    ...
    gameBlackList = [
        # 游戏
        "和平精英 光遇 荣耀 炉石 鸢 秋季赛 第五人格 星穹铁道 kpl jdg 皮肤 阵容 回归 勇士 联盟 战队 九尾 绝区零 鸣潮 剑",
    ...
    lifeList = [
        ...
        # 食
        "外卖 食物 面包 烤肉 茶 蛋糕 粥 夜宵 良品铺子 泡面 毒 海底捞 烟 饿 炒 蒜 笋 粮 厨 蛋挞 粽",
        # 水果
        "榴莲 荔枝 瓜 梨 莓",
        # 动物
    ...
    otherList = [
        ...
        "古 童年 早期 此刻",
        # 表述
        "最 才 还 仍 只 观 佩服 终于 太 配 难 一定 口碑 一起 稳健 不能",
        # 问
