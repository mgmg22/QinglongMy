...
def filter_item(realtime_item):
    ...
    nameBlackList = [
        ...
        # 名
        "磊 祺 咪 梓 禹 楷 灿 栩 琦 毓 鑫 莹 豪 琳 帝 俊 楠 婧 娜 皓 霏 霞 惠 莎 丽 蕾 梦",
        # 英文
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 素人 大片 磕 人气 明星 杀青 结局 白月光 番",
        # 女性
