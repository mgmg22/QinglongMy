...
def filter_item(realtime_item):
    ...
    otherList = [
        ...
        "说 对话 谈 称 聊 诉 喊 言",
        # 娱乐
        "团 娱 艺 剧 恋 乐 毯 逝 赛 唱 歌 舞 演 戏 幼 婚 孕 胎 飒 经纪 网红 公司  yb  解约 解散 维密 路透 票房 收官 钓系 镜头 亮相 海报 刊 出道 拍 秀 名人",
        ...
        "把 让 为 推 吹 走",
        # 未发生
        "呼吁 建议 警惕 永远 差点 心愿 未 可能 相信 网传 快 劝 不再 推进 疑 以为 挑衅 假 真的 明 理解 幻 仙 魔 魂 如果 险 抽 预 命运",
        # 水
