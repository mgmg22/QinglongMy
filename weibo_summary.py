...
def filter_item(realtime_item):
    ...
    otherList = [
        ...
        "开机 追星 长得 辟谣 古装 魅 梗 工作室 女装 模仿 影 松弛 耶 顶流 表情 粉 档 照 合约 续约 资源 摄 组合 咖 幕 男主 见面 配角 素人 大片 磕 人气 明星 结局 白月光 番",
        # 女性
        ...
        "把 让 为",
        # 学
        "大学 教授 校 清华 浙大 专家 班主任 小学 中学 同学 四六级 师 高一 高二 高三 大一 大二 大三 大四 硕 打卡 早八 迟到 简历 摸鱼 应届 成年 私立 考研 面试",
        # 未发生
        ...
        # 情绪
        "担心 抑郁 情绪 骗 背锅 值得 恶心 智障 离谱 吧 挺 却 狠狠 狂喜 意难平 悼 后悔 内耗 天塌了 又又 哭 居然 焦虑 吓 没想到 晕",
        # 问
