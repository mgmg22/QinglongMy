...
def filter_list(tr):
    ...
    commonBlackList = [
        ...
        "k70",
        # ----生活居家----
        "內衣", "拖鞋", "洞洞鞋", "购物袋", "布袋", "婴儿", "小孩", "孩子", "辣妈", "无线", "牙膏", "拉拉裤", "伞",
        "锅", "电动车", "盔", "清风", "纸", "维达",
        "杯", "椅", "菌", "石头", "奥妙", "家政", "冈本", "南极人", "巾", "染", "一次性", "蚊香", "容声",
        # ----风险----
        "风险", "美元", "提额", "保险", "开通", "境外", "秒批", "下卡", "开户", "贷", "征信", "费率",
    ]
    highBlackList = [
        "【顶】",
        # ----玩法----
        ...
        "被封", "禁", "修复", "盾", "砍", "赔", "秒退", "限额", "吧里", "赖", "水贴", "吐了", "真的假的", "妹",
        # ----时效----
    ...
    lowBlackList = [
        ...
        # ----饮料----
        "饮料", "奶茶", "果汁", "奈雪", "蜜雪", "农夫山泉", "矿泉水", "茅台", "酒", "窖", "特仑苏", "椰子",
        "茶叶", "观音", "coco",
        # ----美妆个护----
        ...
        # ----线下门店----
        "老乡鸡", "沪上阿姨", "永和大王", "沃尔玛", "永辉", "盒马", "联华", "茶百道",
        # ----无效----
