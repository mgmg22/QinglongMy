...
commonBlackList = [word for item in [
    "定位 部分 东北 徽 限上海 限深圳 北京 天津 重庆 深圳地区 山东 福建 江苏 云南 江西 河北 广东 吉林 湖北 河南 陕西 湖南 四川 宁夏 广西 辽宁 甘肃 内蒙古 青海 贵州 山西 新疆",
    ...
    # ----风险----
    "风险 美元 提额 保险 开通 境外 秒批 下卡 开户 贷 征信 费率 pos 人脸 审批 黄牛 客服 天天基金",
] for word in item.split()]
...
lowBlackList = [word for item in [
    ...
    # ----食品----
    "三只松鼠 百草味 海底捞 认养一头牛 火锅 烧烤 麻辣烫 馋嘴 卤 炖 火腿 爪 蛋白 豆浆 维生素 麦片 飞鹤 粥 面 小麦 米线 粉 粮 裙带菜 蒜 阿胶 巧克力 糖",
    # ----生鲜----
    "巧乐兹 梦龙 可生食 羊肉 虾 粽 笋 大闸蟹 海参 榴莲 梨 柠檬 香菇 鲜花 莓 玫瑰 酸菜 雪糕 冰淇淋 柿 脐橙",
    # ----饮料----
