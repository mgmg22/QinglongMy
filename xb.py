...
commonBlackList = [word for item in [
    "定位 部分 东北 徽 限上海 限深圳 北京 天津 重庆 深圳地区 山东 福建 江苏 云南 江西 河北 广东 吉林 湖北 河南 陕西 湖南 四川 宁夏 广西 辽宁 甘肃 内蒙古 青海 贵州 山西",
    "厦门 南京 东莞 广州 南海 苏州 中山 常州 青岛 成都 武汉 合肥 揭阳 无锡 济南 大连 石家庄 泉州 丹东 茂名 长沙 泰州 郑州 惠州 威海 绍兴 哈尔滨",
    # ----卡----
    "万事达 visa 车主 刷卡达标 北分 陆金所 缤纷生活 浦大喜奔 邮储联名 美团联名 闪光卡 联名卡 邮政数币 农行刷卡金 农行数币 会员返现 兴业生活 农信",
    ...
    # ----风险----
    "风险 美元 提额 保险 开通 境外 秒批 下卡 开户 贷 征信 费率 pos 人脸 审批 黄牛",
] for word in item.split()]
highBlackList = [word for item in [
    ...
    "被封 禁 修复 盾 砍 赔 秒退 限额 吧里 赖 水贴 吐了 真的假的 妹 聊 惨 起诉",
    # ----时效----
...
lowBlackList = [word for item in [
    "多拍 券包 免单 预售 试用 点秒杀 以旧换新 小程序下单 直播间下单 折券",
    # ----食品----
    "三只松鼠 百草味 海底捞 火锅 烧烤 麻辣烫 馋嘴 卤 炖 火腿 爪 蛋白 豆浆 维生素 麦片 飞鹤 粥 面 小麦 米线 粉 粮 裙带菜 蒜 阿胶",
    # ----生鲜----
...
2. 吐槽
3. 美妆个护商品
4. 限定这些地区的活动（上海、深圳、北京、天津、重庆）注意"上海交通卡"是全国通用的活动
5. 提问或求助帖(买什么 买那个)
