...
def filter_list(tr):
    ...
    commonBlackList = [
        ...
        "平安信", "平安银行信", "中行信", "中国银行信", "民生信", "邮储信", "农行信", "交行信", "光大信", "光大心用卡",
        "广发", "恒丰", "汇丰", "农商",
        "邮储联名", "邮储美团联名", "闪光卡", "浦大喜奔", "缤纷生活", "万事达",
        "宝石山", "众邦", "联名卡", "农行刷卡金", "北分", "交通银行数币", "交行数币", "光大麦当劳",
        "刷卡达标",
        # ----无效----
        "特邀", "受邀", "瘦腰", "收腰",
    ]
    highBlackList = [
        ...
        "有没有", "有问", "行不", "何解", "不行", "原因", "帮忙看", "能不能", "哪来的", "都多少", "是多少", "是不是",
        "果熟", "有果", "油果", "彦祖", "多不",
        # ----符号----
        ...
        "无耻", "便宜啊", "麻烦", "不如不", "狗了", "差了", "终于", "太次了",
        # ----负面----
        "删了", "续费", "限制使用", "被盗", "差评", "监控", "套牢", "猫饼", "怀疑", "不知道", "真的假的",
        "我没有", "想法", "网友", "挤",
        # ----时效----
        "以后", "即将", "过期", "长期出", "逾期", "不能卖", "发货", "退货", "防身", "前10", "前年",
        # ----end----
        "黄了", "没了", "下线", "凉了", "领不了", "领完了", "我才", "没抢到", "未到账", "凉凉", "抢不到",
        "上限", "退款", "不给退", "不能用",
