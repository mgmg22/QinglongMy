...
titleBlackList = [
    ...
    "旅行 乒乓",
    # 游戏
    "黑神话 悟空 悟能 大圣 风灵月影 二郎神 杨戬 虎先锋 文明 王者荣耀 氪 私服 魔兽世界 桌游 原神",
    # 学生
    "幼儿园 小学 初中 高中 大学 硕士 毕业 应届 读博 博士 实习 面试 入职 学姐 班主任 就业",
    # 男女
    "相亲 结婚 未婚 男朋友 舔狗 离婚 出轨 七夕 约会 小孩 表白 分手 女友 婚纱 搭讪 撩妹 猥亵 彩礼",
    # 外国
    ...
    # 歌手
    "雷军 张杰 法老 GAI 邓紫棋 林俊杰 陈奕迅 陶喆 方大同 张艺兴 吴彦祖 成龙 许嵩 韩红 孙燕姿",
    # 名人
    "李云龙 蒋介石 科比 余承东",
    # 历史
    "清朝 宋 秦始皇 关羽 张角",
    ...
    "郑州 云南 福建 江西",
    # 广告
    "莆田 鞋 接单 黄牛 口碑 笔记本 信用卡",
    # 标题党
    "到底是 一口气 名场面 盘点 难以置信 ",
    # 水
    "关于我是 VLOG 万粉 w粉 奖牌 虎扑 彩票 刮刮乐 米其林 外卖",
]
userBlackList = [
    "豆瓣 电影 剧 梗 唱 歌",
    # 注释
